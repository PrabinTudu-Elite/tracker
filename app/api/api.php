...
if (isset($_POST['edit_vehicle'])) {
    var_dump($_POST);
    $id = $_REQUEST['id'];
    $veh_num = $_REQUEST['veh_num'];
    $veh_type = $_REQUEST['veh_type'];
    $veh_model = $_REQUEST['veh_model'];
    $veh_cost = $_REQUEST['veh_cost'];
    $area_locality = $_REQUEST['area_locality'];
    $gps_number = $_REQUEST['gps_number'];
    $veh_img = $_REQUEST['veh_img'];
    $is_ev = (int) $_REQUEST['is_ev'];
